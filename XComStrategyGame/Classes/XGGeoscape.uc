...
function TGeoscapeAlert MakeAlert(XGStrategyActorNativeBase.EGeoscapeAlert eAlert, optional int iData1, optional int iData2, optional int iData3, optional int iData4) {}
...
function bool CanIdentifyCraft(XGGameData.EShipType eCraft){}
...
function DetermineMap(XGMission kMission, optional XGGameData.EMissionTime eTime){}
...
function HideEarth(){}
function bool CountryHasAbductionMission(XGGameData.ECountry eTargetCountry){}
function UpdateCountryColors(){}
function ColorCountry(XGGameData.ECountry eCntry, Color Col){}
function ClearCountryColor(XGGameData.ECountry eCntry, Color Col){}
function PulseCountry(XGGameData.ECountry eCntry, Color col1, Color col2, float fTime){}
function UpdateUI(float fDeltaT){}
function OnHQAssaultIntroComplete(){}
simulated function PreloadSquadIntoSkyranger(XGStrategyActorNativeBase.EGeoscapeAlert eAlertType, bool bUnload){}
simulated function UnloadPreloadedSquad(){}
final simulated function PreloadSquad(){}
